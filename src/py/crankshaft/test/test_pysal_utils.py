...
class PysalUtilsTest(unittest.TestCase):
    ...
    def test_query_attr_select(self):
        ...
        ans1 = 'i."andy"::numeric As attr1, ' 'i."jay_z"::numeric As attr2, '

        ans2 = 'i."price"::numeric As attr1, ' 'i."sq_meters"::numeric As attr2, '

        ans3 = 'i."sq_meters"::numeric As attr1, ' 'i."price"::numeric As attr2, '
    ...
    def test_query_attr_where(self):
        ...
        ans1 = 'idx_replace."andy" IS NOT NULL AND ' 'idx_replace."jay_z" IS NOT NULL'

        ans_array = (
            'idx_replace."_2013_dec" IS NOT NULL AND '
