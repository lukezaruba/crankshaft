...
class MoranTest(unittest.TestCase):
    ...
    def test_local_stat(self):
        ...
        result = moran.local_stat(
            "subquery", "value", "knn", 5, 99, "the_geom", "cartodb_id"
        )
    ...
    def test_moran(self):
        ...
        moran = Moran(FakeDataProvider(data))
        result = moran.global_stat(
            "table", "value", "knn", 5, 99, "the_geom", "cartodb_id"
        )
